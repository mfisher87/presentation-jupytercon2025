...
interactive computing experiences in Jupyter]{.jupyter-orange} to enable **more
people to confidently engage with geospatial data**.
...
explore(
  my_xarray_dataarray,
  {my_geodataframe, symbology="choropleth"},
)
```
...
special interest in how you think the Jupyter technical architecture can be
applied to make geospatial data workflows more accessible and enjoyable.
